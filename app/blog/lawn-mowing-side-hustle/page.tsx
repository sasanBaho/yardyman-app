...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "how to make extra money mowing lawns",
    "lawn care side hustle income",
    "make money cutting grass",
    "best side hustles 2025",
    "yard work side hustle",
    "how to start a lawn mowing business",
    "extra income lawn care",
  ...
  openGraph: {
    ...
    description:
      "Lawn mowing is one of the most overlooked — and most profitable — side hustles out there. No experience required, no boss, no commission. Just good pay and flexible hours.",
    type: "article",
    publishedTime: "2025-05-07",
  },
};

export default function LawnMowingSideHustle() {
  return (
    <BlogPostLayout
      title="How Lawn Mowing Can Be the Perfect Side Hustle to Make Extra Money"
    ...
    >
      ...
      <H3>1. The demand is massive and consistent</H3>
      <P>
      ...
      <H3>3. You set your own schedule</H3>
      <P>
      ...
      <H3>4. Physical work that pays more than most desk side gigs</H3>
      <P>
      ...
      <TipBox>
        A provider who cuts 5 lawns on a Saturday at $50 each earns $250 in a single day — without a boss, without commission, without waiting for a payout algorithm.
      </TipBox>
      ...
      <BulletList items={[
        <><strong>Small yard (under 2,500 sq ft):</strong> $35–$55 per cut</>,
        <><strong>Medium yard (2,500–5,000 sq ft):</strong> $50–$80 per cut</>,
        <><strong>Large yard (5,000+ sq ft):</strong> $75–$150+ per cut</>,
        <><strong>Add-ons (edging, trimming, leaf blowing):</strong> +$10–$30 per job</>,
      ]} />
      <P>
      ...
      <ImagePlaceholder label="Photo placeholder — upload an image showing before/after of a freshly cut lawn" />

      <Divider />

      <H2>How to Get Your First Clients Fast</H2>
      <P>
      ...
      <TipBox>
        Offer a "lawn care package" — weekly or bi-weekly cuts bundled at a slight discount. Recurring packages give you predictable income and reduce the time you spend scheduling new bookings.
      </TipBox>

      <Divider />

      <H2>Lawn Mowing vs. Other Popular Side Hustles</H2>
      <P>
        It's worth comparing lawn care against the most popular side hustles people are searching for right now:
      </P>
      <BulletList items={[
        <><strong>Lawn mowing vs. food delivery:</strong> Delivery pays $12–$18/hour after gas and wear on your car. Lawn mowing pays $40–$80/hour without the constant driving between pickups and drop-offs.</>,
        <><strong>Lawn mowing vs. rideshare driving:</strong> Uber/Lyft take 25–30% commission on every ride. With lawn care, you keep 100% of what the homeowner pays you — no middleman taking a cut.</>,
        <><strong>Lawn mowing vs. selling online:</strong> eCommerce and reselling require inventory, shipping, returns, and constant sourcing. Lawn care needs only your time and your mower.</>,
        <><strong>Lawn mowing vs. freelance gigs:</strong> Freelance work (writing, design, coding) often requires years of skill-building before it pays well. Lawn mowing is something you can start and get paid for this weekend.</>,
      ]} />
      ...
      <H2>Build It Into Real Income</H2>
      <P>
